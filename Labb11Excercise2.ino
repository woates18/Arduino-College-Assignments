...
#define JOYSTICK_X A0    // Connect Joystick X output to analog pin A0
#define JOYSTICK_Y A1    // Connect Joystick Y output to analog pin A1
...
void loop() {
  ...
  // Send Joystick X and Y values via Bluetooth
  mySerial.print("X:");
  mySerial.println(xValue);
  mySerial.print("Y:");
  mySerial.println(yValue);

  // Check if data is available to read from BLE module
